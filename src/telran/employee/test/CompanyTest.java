...
class CompanyTest {
    ...
    void setUp() {
        ...
        employees[0] = new Manager(1000, "John", "Smith", 182, 20000, 20);
        employees[1] = new WageEmployee(2000, "Mary", "Smith", 182, 40);
        employees[2] = new SalesManager(3000, "Peter", "Jackson", 182, 40000, 0.1);
        employees[3] = new SalesManager(4000, "Rabindranate", "Agrawal", 91, 80000, 0.1);
